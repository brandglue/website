...
export const TargetAudiencePersonas: FC<IOwnProps> = ({ className = '' }) => (
  <Svg
    aria-labelledby="TargetAudiencePersonasTitle"
    className={className}
    role="img"
    viewBox="0 0 152 152"
    xmlns="http://www.w3.org/2000/svg"
  >
    <title id="TargetAudiencePersonasTitle">TargetAudiencePersonas Icon</title>
...
export default TargetAudiencePersonas;
